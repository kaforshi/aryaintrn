...
## Deployment ke Ubuntu Server dengan Cloudflare Tunnel

Untuk deployment ke production, lihat panduan lengkap di folder `deploy/`:

- **[DEPLOYMENT.md](deploy/DEPLOYMENT.md)** - Panduan lengkap deployment
- **[cloudflare-tunnel-setup.md](deploy/cloudflare-tunnel-setup.md)** - Setup Cloudflare Tunnel
- **[README.md](deploy/README.md)** - Quick start deployment
...
3. Setup services (Laravel & Cloudflare Tunnel):
```bash
